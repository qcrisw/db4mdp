referencesdict= {"[1]": "R. Amar, J. Eagan, and J. Stasko. Low-level components of analytic activity in information visualization. In Symp. Info. Vis., pp. 111–117, 2005.", 
"[2]": "E. Amorim, E. Brazil, L. G. Nonato, F. Samavati, and M. Sousa. Mul- tidimensional projection with radial basis function and control points selection. In PacificVis, pp. 209–216, 2014.",
...
"[4]": "M.Aupetit.Visualizingdistortionsandrecoveringtopologyincontinuous projection techniques. Neurocomputing, 70(7):1304–1330, 2007.",
"[5]": "M.Aupetit.Sanitycheckforclass-coloring-basedevaluationofdimen- sion reduction techniques. In BELIV, pp. 134–141, 2014.",
"[6]": "M.Aupetit,L.Allano,I.Espagnon,andG.Sannie.Visualanalyticsto check marine containers in the eritr@c project. In EuroVAST, 2010.",
...
"[9]": "M.AupetitandM.Sedlmair.Sepme:2002newvisualseparationmea- sures. In PacificVis, pp. 1–8, 2016.",
...
"[14]": "H.-U.BauerandK.Pawelzik.Quantifyingtheneighborhoodpreservation of self-organizing feature maps. IEEE Trans. Neural Networks, 3(4):570– 579, 1992.",
"[15]": "M. Belkin and P. Niyogi. Laplacian eigenmaps for dimensionality re- duction and data representation. Neural Computation, 15(6):1373–1396, 2003.",
...
"[17]": "J.-P.Benzécri.L’analysedesdonnées,vol.2.DunodParis,1973.",
"[18]": "M.Berger,K.McDonough,andL.Seversky.cite2vec:Citation-driven document exploration via word embeddings. IEEE Trans. Vis. Comp. Graph., 23(1):691–700, 2017.",
"[19]": "J.Bertin.SemiologyofGraphics.Univ.Wisc.Press,1983.",
"[20]": "E.Bertini,A.Tatu,andD.Keim.Qualitymetricsinhigh-dimensional data visualization: An overview and systematization. IEEE Trans. Vis. Comp. Graph., 17(12):2203–2212, 2011.",
"[21]": "C.Bishop.PatternRecognitionandMachineLearning.Springer-Verlag New York, 2016.",
"[22]": "C. Bishop, M. Svensén, and C. Williams. Gtm: The generative topo- graphic mapping. Neural Computation, 10(1):215–234, 1998.",
"[23]": "I.BorgandP.Groenen.Modernmultidimensionalscaling:Theoryand applications. Springer Science & Business Media, 2005.",
"[24]": "U. Brandes and C. Pich. Eigensolver methods for progressive multidi- mensional scaling of large data. In Graph Drawing, pp. 42–53, 2006.",
"[25]": "M. Brehmer and T. Munzner. A multi-level typology of abstract vi- sualization tasks. IEEE Trans. Vis. Comp. Graph., 19(12):2376–2385, 2013.",
"[26]": "M. Brehmer, M. Sedlmair, S. Ingram, and T. Munzner. Visualizing dimensionally-reduced data: interviews with analysts and a characteriza- tion of task sequences. In BELIV, pp. 1–8, 2014.",
"[27]": "B. Broeksema, A. Telea, and T. Baudel. Visual analysis of multi- dimensional categorical data sets. Comp. Graph. Forum., 32(8):158–169, 2013.",
"[28]": "E.T.Brown,J.Liu,C.E.Brodley,andR.Chang.Dis-function:Learning distance functions interactively. In IEEE VAST, pp. 83–92, 2012.",
"[29]": "A.Buja,D.Swayne,M.Littman,N.Dean,H.Hofmann,andL.Chen. Data visualization with multidimensional scaling. J. Comp. and Graph. Stat., 17(2):444–472, 2008.",
"[30]": "N.Cao,D.Gotz,J.Sun,andH.Qu.DICON:Interactivevisualanalysisof multidimensional clusters. IEEE Trans. Vis. Comp. Graph., 17(12):2581– 2590, 2011.",
...
"[36]": "S. Cheng and K. Mueller. The data context map: Fusing data and at- tributes into a unified display. IEEE Trans. Vis. Comp. Graph., 22(1):121– 130, 2016.",
...
"[39]": "D.Coimbra,R.Martins,T.Neves,A.Telea,andF.Paulovich.Explaining three-dimensional dimensionality reduction plots. Info. Vis., 15(2):154– 172, 2016.",
"[40]": "R.Cutura,S.Holzer,M.Aupetit,andM.Sedlmair.Viscoder:Atoolfor visually comparing dimensionality reduction algorithms. ESANN, 2018.",
"[41]": "T.DangandL.Wilkinson.Scagexplorer:Exploringscatterplotsbytheir scagnostics. In PacificVis, pp. 73–80, 2014.",
"[42]": "J.DeLeeuwandW.Heiser.Multidimensionalscalingwithrestrictions on the configuration. Multivariate Analysis, 5:501–522, 1980.",
"[43]": "P. Demartines and J. Hérault. Curvilinear component analysis: A self- organizing neural network for nonlinear mapping of data sets. IEEE Trans. on Neural Networks, 8(1):148–154, 1997.",
"[44]": "L.DiCaro,V.Frias-Martinez,andE.Frias-Martinez.Analyzingtherole of dimension arrangement for data visualization in radviz. In Advances in Knowledge Discovery and Data Mining, pp. 125–132. Springer, 2010.",
...
"[47]": "S.Fadel,F.Fatore,F.Duarte,andF.Paulovich.Loch:Aneighborhood- based multidimensional projection technique for high-dimensional sparse spaces. Neurocomputing, 150:546–556, 2015.",
"[48]": "C.FaloutsosandK.Lin.Fastmap:Afastalgorithmforindexing,datamin-ing and visualization of traditional and multimedia databases. In ACM SIGMOD, pp. 163–174, 1995.",
"[49]": "F.Fernández,M.Verleysen,J.Lee,andI.Blanco.Stabilitycomparison of dimensionality reduction techniques attending to data and parameter variations. In EuroVis (Short Paper), 2013.",
...
"[53]": "X. Geng, D.-C. Zhan, and Z.-H. Zhou. Supervised nonlinear dimen- sionality reduction for visualization and classification. IEEE Trans. Sys., Man, and Cyber., 35(6):1098–1107, 2005.",
...
"[58]": "E. Gomez-Nieto, F. San Roman, P. Pagliosa, W. Casaca, E. Helou, M. Oliveira, and L. Nonato. Similarity preserving snippet-based visual- ization of web search results. IEEE Trans. Vis. Comp. Graph., 20(3):457– 470, 2014.",
"[59]": "A. Gracia, S. González, V. Robles, and E. Menasalvas. A methodology to compare dimensionality reduction algorithms in terms of loss of quality. Info. Scie., 270:1–27, 2014.",
"[60]": "B. Gretarsson, J. O’Donovan, S. Bostandjiev, T. Höllerer, A. Asuncion, D. Newman, and P. Smyth. Topicnets: Visual analysis of large text corpora with topic modeling. ACM Trans. Intell. Syst. Techn., 3(2):1–26, 2012.",
...
"[63]": "N. Heulot, J. Fekete, and M. Aupetit. Visualizing dimensionality reduc- tion artifacts: An evaluation. Technical report, May 2015.",
...
"[75]": "S. Kaski, J. Nikkilä, M. Oja, J. Venna, P. Törönen, and E. Castrén. Trustworthiness and metrics in visualizing similarity of gene expression. Bioinformatics,4(1):1,2003.",
"[76]": "D. A. Keim, F. Rossi, T. Seidl, M. Verleysen, and S. Wrobel. Informa- tion visualization, visual data mining and machine learning. Dagstuhl Seminar, 12081:79, 2012.",
...
"[78]": "J. Krause, A. Dasgupta, J. Fekete, and E. Bertini. Seekaview: An intelli- gent dimensionality reduction strategy for navigating high-dimensional data spaces. In LDAV, pp. 11–19, 2016.",
...
"[88]": "D. Lehmann and H. Theisel. General projective maps for multidimen- sional data projection. Comp. Graph. Forum., 35(2):443–453, 2016.",
"[89]": "S. Lespinats and M. Aupetit. Checkviz: Sanity check and topologi- cal clues for linear and non-linear mappings. Comp. Graph. Forum., 30(1):113–125, 2011.",
...
"[94]": "J. Lötsch and A. Ultsch. A machine-learned knowledge discovery method for associating complex phenotypes with complex genotypes. application to pain. J. Biom. Info., 46(5):921 – 928, 2013.",
...
"[102]": "R.Motta,R.Minghim,A.Lopes,andM.Oliveira.Graph-basedmeasures to assist user assessment of multidimensional projections. Neurocomput- ing, 150:583–598, 2015.",
"[103]": "T.Munzner.VisualizationAnalysisandDesign.A.K.Petersvisualization series. A.K. Peters, 2014.",
...
"[106]": "H. Osipyan, M. Kruliš, and S. Marchand-Maillet. A Survey of CUDA- based Multidimensional Scaling on GPU Architecture. In C. Schulz and D. Liew, eds., Imper. College Comp. Student Workshop, vol. 49, pp. 37–45, 2015.",
...
"[112]": "A. Pandey, J. Krause, C. Felix, J. Boy, and E. Bertini. Towards un- derstanding human similarity perception in the analysis of large sets of scatter plots. In Conf. on Human Fact. in Comp. Sys., pp. 3659–3669, 2016.",
"[113]": "S. Park, S.-Y. Shin, and K.-B. Hwang. Cfmds: Cuda-based fast multi- dimensional scaling for genome-scale data. Bioinformatics, 13(17):1, 2012.",
...
"[119]": "F. Paulovich, F. Toledo, G. Telles, R. Minghim, and L. G. Nonato. Se- mantic wordification of document collections. Comp. Graph. Forum., 31(3pt3):1145–1153, 2012.",
...
"[121]": "N. Pezzotti, T. Höllt, B. Lelieveldt, E. Eisemann, and A. Vilanova. Hier- archical stochastic neighbor embedding. Comp. Graph. Forum., 35(3):21– 30, 2016.",
...
"[125]": "B. Rieck and H. Leitte. Persistent homology for the evaluation of di- mensionality reduction schemes. Comp. Graph. Forum., 34(3):431–440, 2015.",
...
"[128]": "P. Rousset and C. Guinot. Distance between kohonen classes visualization tool to use som in data set analysis and representation. In Bio-Inspired Ap- plic. Connectionism: Int. Work-Conf. on Artif. Natural Neural Networks, pp. 119–126. 2001.",
"[129]": "S. Roweis and L. Saul. Nonlinear dimensionality reduction by locally linear embedding. Science, 290(5500):2323–2326, 2000.",
"[130]": "D. Sacha, A. Stoffel, F. Stoffel, B. Kwon, G. Ellis, and D. Keim. Knowl- edge generation model for visual analytics. IEEE Trans. Vis. Comp. Graph., 20(12):1604–1613, 2014.",
"[131]": "D. Sacha, L. Zhang, M. Sedlmair, J. Lee, J. Peltonen, D. Weiskopf, S. North, and D. Keim. Visual interaction with dimensionality reduc- tion: A structured literature analysis. IEEE Trans. Vis. Comp. Graph., 1(33):241–251, 2016.",
...
"[134]": "B. Schölkopf, A. Smola, and K.-R. Müller. Kernel principal component analysis. In Int. Conf. Artif. Neural Networks, pp. 583–588, 1997.",
...
"[137]": "C. Seifert, V. Sabol, and W. Kienreich. Stress maps: Analysing local phe- nomena in dimensionality reduction based visualisations. In EuroVAST, pp. 13–18, 2010.",
...
"[148]": "J. Stahnke, M. Dörk, B. Müller, and A. Thom. Probing projections: Interaction techniques for interpreting arrangements and errors of dimen- sionality reductions. IEEE Trans. Vis. Comp. Graph., 22(1):629–638, 2016.",
"[149]": "M. Steiger, J. Bernard, S. Mittelstädt, H. Lücke-Tieke, D. Keim, T. May, and J. Kohlhammer. Visual analysis of time-series similarities for anomaly detection in sensor networks. Comp. Graph. Forum., 33(3):401– 410, 2014.",
...
"[155]": "W. Torgerson. Multidimensional scaling: I. theory and method. Psy- chometrika, 17(4):401–419, 1952.",
...
"[161]": "J.Venna and S.Kaski. Local multidimensional scaling. NeuralNetworks, 19(6):889–899, 2006.",
"[162]": "J. Venna, J. Peltonen, K. Nybo, H. Aidos, and S. Kaski. Information retrieval perspective to nonlinear dimensionality reduction for data visu- alization. J. Mach. Learn. Res., 11:451–490, 2010.",
...
"[168]": "M. Wattenberg,F. Viégas, and I. Johnson. How to use t-sne effectively. Technical report, Distill, 2016.",
...
"[170]": "C. Williams. On a connection between kernel pca and metric multidi-mensional scaling. Machine Learning, 46(1-3):11–19, 2002.",
...
"[173]": "A. Wismüller, M. Verleysen, M. Aupetit, and J. Lee. Recent advances in nonlinear dimensionality reduction, manifold and topological learning. In ESANN, 2010.",
...
"[175]": "J. Ye. Characterization of a family of algorithms for generalized dis- criminant analysis on undersampled problems. J. Mach. Learn. Res., 6:483–502, 2005.",
...
"[179]": "T. Zhang, J. Yang, D. Zhao, and X. Ge. Linear local tangent space align- ment and application to face recognition. Neurocomputing, 70(7):1547– 1553, 2007.",
"[180]": "Z.-y. Zhang and H.-y. Zha. Principal manifolds and nonlinear dimen- sionality reduction via tangent space alignment. J. Shanghai Univ., 8(4):406–424, 2004.",
